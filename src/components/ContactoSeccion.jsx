    ...
    <section className="bg-green-800 text-white py-20 px-6">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-green-200 text-lg mb-8">
          Contactanos hoy y un asesor te ayudará a encontrar la maquinaria ideal para vos.
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center justify-center gap-2 border-2 border-white px-8 py-4 rounded-full font-bold text-lg hover:bg-white hover:text-green-900 transition-all"
          >
