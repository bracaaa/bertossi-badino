  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: "var(--color-roto)" }}>
      ...
      <div className="max-w-5xl mx-auto px-6 py-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-10">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-auto">
              <a href={`https://wa.me/5493576440800?text=Hola,%20me%20interesa%20el%20${encodeURIComponent(nombre)}.%20¿Podría%20darme%20más%20información?`} target="_blank" rel="noreferrer" className="flex-1 btn-primary flex items-center justify-center gap-2">
        ...
        <div style={{ borderLeft: "3px solid var(--color-dorado)", backgroundColor: "var(--color-crema)", borderRadius: "2px", padding: "24px 28px" }}>
          <p className="mb-4" style={{ fontFamily: "var(--font-label)", fontSize: "9px", letterSpacing: "0.22em", textTransform: "uppercase", color: "var(--color-campo)" }}>
            Características principales
          </p>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8">
            {caracteristicas.map((c) => (
              <div key={c} className="flex items-start gap-2 py-2" style={{ borderBottom: "1px solid rgba(0,0,0,0.06)" }}>
                <span style={{ color: "var(--color-dorado)", fontWeight: 700, flexShrink: 0 }}>—</span>
                <span style={{ fontFamily: "var(--font-label)", fontSize: "10px", letterSpacing: "0.06em", color: "var(--color-carbon)" }}>{c}</span>
              </div>
            ))}
          </div>
        </div>
